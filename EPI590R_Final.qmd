...
3.  Create a figure (1 pt)
    ...
    The distribution of `Case Count` is right-skewed, with most regions having a relatively low number of cases and a few having a high number of cases, as shown in @fig-hist-case

    @fig-hist contains a scatter plot across `total_regions` regions.
